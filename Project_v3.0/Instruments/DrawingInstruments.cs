    ...
    public static class DrawingInstruments
    {
        ...
        public static void CheckIntersection(Data data) {
            ...
            Data.this_.Dispatcher.Invoke(new Action(() =>
            {
                if (stIntersection)
                {
                    Data.this_.textBlockItersection.Text = $"Зіштовхнуться: Так ";
                }
                else
                {
                    Data.this_.textBlockItersection.Text = $"Зіштовхнуться: Ні";
                }
        ...
        private static Graphics GetField()
        {
            ...
            graphics.DrawLine(new Pen(Color.DarkRed), 0, Data.Height / 2, Data.Width, Data.Height / 2);
            graphics.DrawLine(new Pen(Color.DarkRed), Data.Width / 2, 0, Data.Width / 2, Data.Height);
            return graphics;
        }
